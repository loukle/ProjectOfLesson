...
<body bgcolor="#E0FFFF">
	...
	<table width="100%">
		<tr height="100" align="center">
			<td><table>
					<tr>
						<input type="button" style="width:200px;height:25px" value="企业备案"
							onClick="window.location.href='admin_1.interchange_beian.jsp'">
						<input type="button" style="width:200px;height:25px" value="企业查询"
							onClick="window.location.href='admin_1.interchange_chaxun.jsp'">
						<input type="button" style="width:200px;height:25px" value="报表管理"
							onClick="window.location.href='admin_1.interchange_guanli.jsp'">
					</tr>
				</table></td>
		</tr>
	</table>
