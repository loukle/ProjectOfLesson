...
<div class="head_td"> 山东省人力资源数据管理系统</div>
    ...
    <div class="nav_m">
        ...
        <ul class="nav clearfix">
            ...
            <li class="now"><a href="admin_2.dataAnalyze_multi-dimensional.jsp">数据分析</a></li>
	...
	<div class="scd_l">
        ...
        <div class="scd_lm">
            <ul class="s_nav s_nav_a">
                <li class="now">
                    <div class="li_m">
                        <a href="admin_2.dataAnalyze_multi-dimensional.jsp"><span>多维分析</span></a>
                    </div>
                </li>
                <li>
                    <div class="li_m">
                        <a href="admin_2.dataAnalyze_charts.jsp"><span>图表分析</span></a>
                    </div>
                </li>
            </ul>
        </div>
