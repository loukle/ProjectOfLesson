...
<body bgcolor="#E0FFFF">
	...
	<table width="100%">
		<tr height="100" align="center">
			<td><table>
					<tr>
						<input type="button" style="width:200px;height:25px" value="发布通知"
							onClick="window.location.href='admin_4.systemManagement_bufa.jsp'">
						<input type="button" style="width:200px;height:25px" value="设置时限"
							onClick="window.location.href='admin_4.systemManagement_sheji.jsp'">
						<input type="button" style="width:200px;height:25px" value="管理用户"
							onClick="window.location.href='admin_4.systemManagement_guanli.jsp'">
						<input type="button" style="width:200px;height:25px" value="监控系统"
							onClick="window.location.href='admin_4.systemManagement_jiankong.jsp'">
					</tr>
				</table></td>
		</tr>
	</table>
