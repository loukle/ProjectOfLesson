...
<div class="head_td"> 山东省人力资源数据管理系统</div>
    ...
    <div class="nav_m">
        ...
        <ul class="nav clearfix">
            ...
            <li class="now"><a href="shiuser_1.recorded.jsp">企业备案</a></li>
            <li><a href="shiuser_2.report_search.jsp">报表管理</a></li>
        </ul>
    </div>
</div>
<!--头部-->
	...
	<div class="scd_l">
        ...
        <div class="scd_lm">
            <ul class="s_nav s_nav_a">
                <li class="now">
                    <div class="li_m">
                        <a href="shiuser_1.recorded.jsp"><span>已备案</span></a>
                    </div>
                </li>
                <li>
                    <div class="li_m">
                        <a href="shiuser_1.notRecorded.jsp"><span>未备案</span></a>
                    </div>
                </li>
            </ul>
        </div>
